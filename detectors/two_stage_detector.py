...
class TwoStageDetector:
    def __init__(self, model="faster", threshold=0.5):
        self.model = (
            fasterrcnn_mobilenet_v3_large_fpn(
        ...
        self.allowed_indices = [
            2, 3, 4, 5, 6, 7, 9,     # Vehicles
            10, 11, 13, 14,          # Misc
            18, 19, 21,              # Animals
            33, 62, 72, 82, 84       # Box like objects
        ]
    ...
    def detect_all_full(self, image):
        ...
        processed = [
            ...
            if single_detection[1] in self.allowed_indices and single_detection[2] > self.threshold
        ]
